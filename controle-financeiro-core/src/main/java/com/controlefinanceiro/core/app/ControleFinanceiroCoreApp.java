...
public final class ControleFinanceiroCoreApp {
    ...
    public static void main(String[] args) {
        ...
        UsuarioService usuarioService = new UsuarioService(usuarioRepository, new Pbkdf2PasswordHasher());
        ...
        Usuario usuarioTeste = usuarioRepository.buscarPorEmail("maria@teste.com").orElse(null);
    ...
    private static void testarResumoNaoMisturaMovimentacoesDeOutroUsuario(
        ...
        try {
            ...
            Usuario joao = usuarioRepository.buscarPorEmail("joao@teste.com").orElse(null);

            movimentacaoService.registrarMovimentacao(joao, 999.0, "Movimentação do João",
                    TipoMovimentacao.ENTRADA, 2);

            Usuario maria = usuarioRepository.buscarPorEmail("maria@teste.com").orElse(null);
